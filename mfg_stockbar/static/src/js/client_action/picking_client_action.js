odoo.define('mfg_stockbar.picking_client_action', function (require) {
'use strict';

var core = require('web.core');
var ClientAction = require('mfg_stockbar.ClientAction');
    ...
    _showInformation: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            self.ViewsWidget = new ViewsWidget(
                self,
                'stock.picking',
                'mfg_stockbar.stock_picking_barcode',
                {},
    ...
    _onOpenPackage: function (ev) {
        ...
        this.mutex.exec(function () {
            return self._save().then(function () {
                ...
                self.ViewsWidget = new ViewsWidget(self, 'stock.quant', 'mfg_stockbar.stock_quant_barcode_kanban', {}, params, false, 'kanban');
