odoo.define('mfg_stockbar.ClientAction', function (require) {
'use strict';
...
var ViewsWidget = require('mfg_stockbar.ViewsWidget');
var HeaderWidget = require('mfg_stockbar.HeaderWidget');
var LinesWidget = require('mfg_stockbar.LinesWidget');
var SettingsWidget = require('mfg_stockbar.SettingsWidget');
...
var ClientAction = AbstractAction.extend({
    ...
    _getState: function (recordId, state) {
        ...
        if (state) {
            ...
            def = this._rpc({
                'route': '/mfg_stockbar/get_set_barcode_view_state',
                'params': {
                    'record_id': recordId,
                    'mode': 'read',
    ...
    *
            ...
            return self._save().then(function () {
                if (self.actionParams.model === 'stock.picking') {
                    self.ViewsWidget = new ViewsWidget(
                        self,
                        'stock.move.line',
                        'mfg_stockbar.stock_move_line_product_selector',
                        {
                    ...
                    self.ViewsWidget = new ViewsWidget(
                        ...
                        'mfg_stockbar.stock_inventory_line_barcode',
                        {
    ...
    _onMainMenu: function () {
        ...
        self._save().then(function () {
            self.do_action('mfg_stockbar.stock_barcode_action_main_menu', {
