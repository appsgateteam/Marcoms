odoo.define('mfg_stockbar.MainMenu', function (require) {
"use strict";
...
var MainMenu = AbstractAction.extend({
    ...
    events: {
        "click .button_operations": function(){
            this.do_action('mfg_stockbar.stock_picking_type_action_kanban');
        },
            ...
            var options = {
                ...
                buttons: [
                    { text: _t("Remove it"), close: true, classes: 'btn-primary', click: function() {
                        Session.rpc('/mfg_stockbar/rid_of_message_demo_barcodes');
                    }},
    ...
    _onBarcodeScanned: function(barcode) {
        ...
        Session.rpc('/mfg_stockbar/scan_from_main_menu', {
            barcode: barcode,
