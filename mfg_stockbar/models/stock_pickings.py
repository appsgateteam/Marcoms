...
class StockPicking(models.Model):
    ...
    def get_po_to_split_from_barcode(self, barcode):
        ...
        view_id = self.env.ref('mfg_stockbar.view_barcode_lot_form').id
        return {
    ...
    def open_picking_client_action(self):
        ...
        if use_form_handler:
            ...
            action = self.env.ref('mfg_stockbar.stock_barcode_picking_client_action').read()[0]
            params = {
                'model': 'stock.picking',
                'picking_id': self.id,
...
class StockPickingType(models.Model):
    ...
    def get_action_picking_tree_ready_kanban(self):
        return self._get_action('mfg_stockbar.stock_picking_action_kanban')
