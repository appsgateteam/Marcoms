...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'acc_pi.template_followup_report'
        templates['line_template'] = 'acc_pi.line_template_followup_report'
        return templates
    ...
    def print_followups(self, records):
        ...
        return self.env.ref('acc_pi.action_report_followup').report_action(res_ids)
