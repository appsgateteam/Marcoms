...
class AccountReport(models.AbstractModel):
    ...
    def _get_templates(self):
        return {
                'main_template': 'acc_pi.main_template',
                'main_table_header_template': 'acc_pi.main_table_header',
                'line_template': 'acc_pi.line_template',
                'footnotes_template': 'acc_pi.footnotes_template',
                'search_template': 'acc_pi.search_template',
        }
    ...
    def open_general_ledger(self, options, params=None):
        ...
        ctx = self.env.context.copy()
        ctx.pop('id', '')
        action = self.env.ref('acc_pi.action_account_report_general_ledger').read()[0]
    ...
    def get_html_footnotes(self, footnotes):
        template = self._get_templates().get('footnotes_template', 'acc_pi.footnotes_template')
