...
class ResPartner(models.Model):
    ...
    def _get_needofaction_fup_lines_domain(self, date):
        # that part of the domain concerns the date filtering and is overwritten in mfb_account_reports_followup
    ...
    def open_action_followup(self):
        ...
        return {
            ...
            'view_mode': 'form',
            'views': [[self.env.ref('acc_pi.customer_statements_form_view').id, 'form']],
